...
PLUGIN_CATALOG = {
    ...
    "lighting": {
        ...
        "downloadable": True,
        "tag": "v0.23.0",
        "sha256": "49d47732cd0fb4c2c4a642871a5e4b290f6722fb09e5e02219dff06f2387f9ab",  # sha256 real del tarball de v0.23.0, verificado contra una descarga real antes de fijarlo aqui (editor visual de reglas)
